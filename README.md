# Hi there, I'm Devindu Malshan 👋

A passionate **Software Engineering & Data Science student** dedicated to bridging the gap between robust software development and advanced artificial intelligence. I specialize in building full-stack web applications, engineering smart IoT ecosystems, and training machine learning models to solve real-world industrial and digital problems.

---

### 🚀 About Me

* 🧠 **Current Focus:** Advanced Deep Learning, Generative AI applications, and robust MLOps pipelines.
* 🎓 **Education:** Pursuing a B.Sc. (Hons) in Data Science from London Metropolitan University and completing a Pearson BTEC Level 5 HND in Computing at ESOFT Metro College.
* 💼 **Professional Approach:** Experienced in translating complex technical architectures into user-centric interfaces and automated data-driven solutions.
...
#### 🏥 RemoMed Portal
* **Description:** A highly responsive and secure digital telemedicine portal designed specifically to optimize practice workflows, scheduling, and patient interaction channels for modern medical practitioners.
* **Tech Stack:** `HTML5`, `Tailwind CSS`

#### 🌍 Eco-Tourism Cloud Platform
* **Description:** A sustainable, data-driven travel experiences platform built to empower eco-conscious travelers with interactive logging, planning tools, and resource metrics.
* **Tech Stack:** `HTML5`, `Vanilla JavaScript`, `Tailwind CSS`, `Chart.js`, `FontAwesome 6`

#### 🏙️ Urban Nexus — Smart City Prototype
* **Description:** A smart city management system prototype showcasing role-based dashboards for citizens and administrators covering energy monitoring, public safety tracking, and automated transit systems.
* **Tech Stack:** `Figma (Advanced UI/UX)`, Interactive Prototyping

#### 🎵 Sonicsieve Metadata Song Studio
* **Description:** A clean, high-fidelity digital desktop studio layout tailored for managing, previewing, and enriching localized audio files with descriptive high-fidelity metadata.
* **Tech Stack:** `HTML5`, `Tailwind CSS`

#### ⏰ Timely Aura Premium Alarm App
...
* **Google Cloud Specialization** — Machine Learning on Google Cloud
* **Google Cloud Specialization** — MLOps: Machine Learning Operations
* **Google Cloud Certification** — Production Machine Learning Systems & Generative AI Fundamentals
* **Google Professional Certificate** — Google IT Support Specialization
